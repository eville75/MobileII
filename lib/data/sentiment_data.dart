final Map<String, List<String>> allSentiments = {
  ...
  'Sentimentos Negativos': [
    'Tristeza', 'Raiva', 'Ansiedade', 'Medo', 'Solidão', 'Melancolia',
    'Ciúmes', 'Insegurança', 'Frustração', 'Angústia', 'Desespero',
    'Desânimo', 'Desapontamento', 'Culpa', 'Arrependimento', 'Impaciência',
    'Estresse', 'Vergonha', 'Mágoa', 'Cansaço',
  ],
